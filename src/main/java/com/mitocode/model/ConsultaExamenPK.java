...
public class ConsultaExamenPK implements Serializable{
	...
	@ManyToOne
	@JoinColumn(name= "id_examen", nullable = false, foreignKey = @ForeignKey(name="pk_examen_consulta"))

	private Examen examen;
	@ManyToOne
	@JoinColumn(name = "id_consulta", nullable = false, foreignKey = @ForeignKey(name="pk_consulta_examen"))
